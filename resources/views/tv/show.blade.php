...
@section('content')
    <div class="tv-detail border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-column md:flex-row">
            <div class="flex-none">
                <img src="{{$tv['poster_path']}}" alt="{{ $tv['name'] }}" class="w-64 md:w-96">
            </div>
            <div class="ml-24">
                ...
                @foreach($tv['cast'] as $cast)
                    <div class="mt-8 hover:opacity-75 transition ease-in-out duration-150">
                        <a href="{{ route('actors.show', $cast['id']) }}">
                            <img src="{{ movie_poster($cast['profile_path']) }}" alt="{{ $cast['name'] }}">
                        </a>
                        <div class="mt-2">
                            <a href="{{ route('actors.show', $cast['id']) }}"
    ...
    <div class="tv-images border-b border-gray-800" x-data="{ isOpen: false, image: null }">
        <div class="container mx-auto px-4 py-16">
